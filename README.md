...
Не является обязательным условием реализации. Можно создать свой уникальный элемент интерфейса для перехода к оплате Долями. 
...
pointId |`String?` | Уникальный идентификатор точки. Передается в случае наличия нескольких точек у клиента-интегратора на одной учетной записи |
